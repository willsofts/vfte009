...
2. api try out, this is supported api that you have created ex. \
    curl -X POST http://localhost:8080/api/sfte009/list

This vue application using `sfte009` api to manipulate transaction. \
...
### Testing
1. Normally copy output folder after build success ex. vfte009 into [vueserve](https://github.com/willsofts/vueserve) project under public path and then you can launch it directly ex. 

    http://localhost:8080/vfte009/vfte009.html
